...
unsigned int nStakeMinAge = 60 * 60 * 8;	// minimum age for coin age: 1h
...
int64 nChainStartTime = 1456715993;
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
    ...
    else if(nHeight > 1 && nHeight <= 43200)
    {
        nSubsidy = 0.0 * COIN;
    }
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in SpeedCoin
    bool fStrictPayToScriptHash = true; // Always active in SpeedCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "SpeedCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "CBigNum Tree empty mapBlockIndex SpeedCoin";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = nChainStartTime + 26;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 299966 : 299966;
		...
		block.print();
		assert(block.hashMerkleRoot == uint256("0xaf3eaf653a0708c05b3bfe4671f2697b45cf34e8760a80e8a2adc6ae49b8ea66"));
